...
<script>
  ...
  import { removeAddFromShelf, appendAddToShelf, categoryList, computedID } from '../../utils/store'
  ...
  export default {
    ...
    methods: {
      ...
      moveOutFromGroup() {//移除书架算法
        this.moveOutFromGroup(this.onComplete)
      },
      createNewGroup() {//新建分组和修改分组名
